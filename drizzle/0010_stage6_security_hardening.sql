-- Stage 6 security hardening: isolate platform authority from tenant roles and make
...
CREATE OR REPLACE FUNCTION indicate_private.stage6_role_permission_scope_guard()
RETURNS trigger
LANGUAGE plpgsql
SECURITY DEFINER
...
END
$$;--> statement-breakpoint
REVOKE ALL ON FUNCTION indicate_private.stage6_role_permission_scope_guard() FROM PUBLIC;--> statement-breakpoint
DROP TRIGGER IF EXISTS stage6_role_permission_scope_guard ON public.role_permissions;--> statement-breakpoint
CREATE TRIGGER stage6_role_permission_scope_guard
BEFORE INSERT OR UPDATE ON public.role_permissions
FOR EACH ROW EXECUTE FUNCTION indicate_private.stage6_role_permission_scope_guard();--> statement-breakpoint
...
CREATE OR REPLACE FUNCTION indicate_private.stage6_provision_platform_permission(
...
END
$$;--> statement-breakpoint
REVOKE ALL ON FUNCTION indicate_private.stage6_provision_platform_permission(uuid, text, text) FROM PUBLIC, indicate_runtime;--> statement-breakpoint

CREATE OR REPLACE FUNCTION indicate_private.stage6_list_platform_permissions(p_user_id uuid)
...
END
$$;--> statement-breakpoint
REVOKE ALL ON FUNCTION indicate_private.stage6_list_platform_permissions(uuid) FROM PUBLIC;--> statement-breakpoint
GRANT EXECUTE ON FUNCTION indicate_private.stage6_list_platform_permissions(uuid) TO indicate_runtime;--> statement-breakpoint
...
DROP FUNCTION IF EXISTS indicate_private.stage6_claim_replay(text, text, uuid, text, timestamptz, timestamptz);--> statement-breakpoint
DROP FUNCTION IF EXISTS indicate_private.stage6_finish_replay(text, text, text, public.replay_claim_status, jsonb, timestamptz);--> statement-breakpoint

CREATE FUNCTION indicate_private.stage6_claim_replay(
...
$$;--> statement-breakpoint
REVOKE ALL ON FUNCTION indicate_private.stage6_claim_replay(text, text, uuid, text, timestamptz, timestamptz, timestamptz) FROM PUBLIC;--> statement-breakpoint
GRANT EXECUTE ON FUNCTION indicate_private.stage6_claim_replay(text, text, uuid, text, timestamptz, timestamptz, timestamptz) TO indicate_runtime;--> statement-breakpoint

CREATE FUNCTION indicate_private.stage6_bind_replay_identity(
...
$$;--> statement-breakpoint
REVOKE ALL ON FUNCTION indicate_private.stage6_bind_replay_identity(text, text, text, uuid, uuid, text) FROM PUBLIC;--> statement-breakpoint
GRANT EXECUTE ON FUNCTION indicate_private.stage6_bind_replay_identity(text, text, text, uuid, uuid, text) TO indicate_runtime;--> statement-breakpoint

CREATE FUNCTION indicate_private.stage6_prepare_replay_outcome(
...
END
$$;--> statement-breakpoint
REVOKE ALL ON FUNCTION indicate_private.stage6_prepare_replay_outcome(text, text, text, uuid, public.replay_claim_status, jsonb, timestamptz) FROM PUBLIC;--> statement-breakpoint
GRANT EXECUTE ON FUNCTION indicate_private.stage6_prepare_replay_outcome(text, text, text, uuid, public.replay_claim_status, jsonb, timestamptz) TO indicate_runtime;--> statement-breakpoint

CREATE FUNCTION indicate_private.stage6_finalize_replay(
...
AS $$
  ...
  LIMIT 1
$$;--> statement-breakpoint
REVOKE ALL ON FUNCTION indicate_private.stage6_finalize_replay(text, text, text, uuid, timestamptz) FROM PUBLIC;--> statement-breakpoint
GRANT EXECUTE ON FUNCTION indicate_private.stage6_finalize_replay(text, text, text, uuid, timestamptz) TO indicate_runtime;--> statement-breakpoint
...
CREATE OR REPLACE FUNCTION indicate_private.stage6_capture_replay_business_receipt()
RETURNS trigger
LANGUAGE plpgsql SECURITY DEFINER
SET search_path = pg_catalog, public, indicate_private
AS $$
...
END
$$;--> statement-breakpoint
REVOKE ALL ON FUNCTION indicate_private.stage6_capture_replay_business_receipt() FROM PUBLIC;--> statement-breakpoint
DROP TRIGGER IF EXISTS stage6_capture_replay_business_receipt ON public.audit_logs;--> statement-breakpoint
CREATE TRIGGER stage6_capture_replay_business_receipt
AFTER INSERT ON public.audit_logs
FOR EACH ROW EXECUTE FUNCTION indicate_private.stage6_capture_replay_business_receipt();--> statement-breakpoint

INSERT INTO public.indicate_schema_migrations(version, name, checksum)
VALUES (11, 'stage6_security_hardening', 'stage6-security-hardening-v1');
