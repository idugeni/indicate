-- Stage 5 durable public routing, exact-domain activation, and recoverable cache invalidation.
...
CREATE OR REPLACE FUNCTION indicate_private.claim_stage5_invalidation_tasks(
  p_now timestamptz,
  p_limit integer,
  p_claim_token uuid,
...
END;
$$;--> statement-breakpoint
REVOKE ALL ON FUNCTION indicate_private.claim_stage5_invalidation_tasks(timestamptz, integer, uuid, timestamptz) FROM PUBLIC;--> statement-breakpoint
GRANT EXECUTE ON FUNCTION indicate_private.claim_stage5_invalidation_tasks(timestamptz, integer, uuid, timestamptz) TO indicate_runtime;--> statement-breakpoint

CREATE OR REPLACE FUNCTION indicate_private.stage5_site_hostname_guard()
...
END;
$$;--> statement-breakpoint
CREATE TRIGGER stage5_site_hostname_guard
BEFORE INSERT OR UPDATE OF organization_id, domain_id, region_id, normalized_hostname ON public.sites
FOR EACH ROW EXECUTE FUNCTION indicate_private.stage5_site_hostname_guard();--> statement-breakpoint

INSERT INTO public.indicate_schema_migrations(version, name, checksum)
VALUES (8, 'stage5_public_delivery', 'stage5-public-delivery-v1');
