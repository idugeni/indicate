...
Tenant live di DB: **114 site = 104 apex + 10 site kota** (`wonosobo.*`, region Wonosobo kind=`city` di bawah region Jawa Tengah). Seluruh 104 apex memiliki exact + wildcard Vercel terverifikasi; 10 regional dilayani wildcard regional tanpa exact Vercel.
