      ...
      {sent ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <Input id="name" required autoComplete="name" value={displayName} onChange={(e) => setDisplayName(e.target.value)} placeholder="Nama Redaksi / Lembaga" className="font-sans" />
          </div>
          ...
          <div>
            ...
            <p className="m-0 mt-1.5 font-sans text-xs text-paper-faint">Minimal 8 karakter.</p>
          </div>
