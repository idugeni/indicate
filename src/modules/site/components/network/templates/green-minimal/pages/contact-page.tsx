                  ...
                  return (
                    <li key={channel.key} className="m-0">
                      <a
                        ...
                        target={external ? '_blank' : undefined}
                        rel={external ? 'noopener noreferrer' : undefined}
                        className="flex h-full items-center gap-2.5 rounded-2xl bg-white p-3 shadow-sm ring-1 ring-slate-200/60 transition-colors hover:ring-[#1d7a38]/50"
                      >
                        <span className="flex h-8 w-8 flex-none items-center justify-center rounded-full bg-[#1d7a38]/10 text-[#1d7a38]">
                          <Icon className="h-4 w-4" />
                        </span>
                        <span className="min-w-0 flex-1">
                          <span className="block font-sans text-sm font-bold text-slate-900">{channel.label}</span>
