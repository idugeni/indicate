...
export function GreenMinimalShell({
  ...
  return (
    <div className="flex min-h-screen flex-col supports-[min-height:100svh]:min-h-svh bg-[#f7faf7] font-sans text-slate-900 antialiased" data-template="green-minimal" style={templateThemeStyle(GREEN_MINIMAL)}>
      <a
        href="#main-content"
