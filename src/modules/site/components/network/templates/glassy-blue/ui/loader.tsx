...
export function GlassyBlueLoader() {
  return (
    <div
      ...
      aria-busy="true"
      aria-label="Memuat"
      className="flex min-h-screen items-center justify-center bg-[#edf4ff]"
    >
      <div aria-hidden="true" className="relative flex h-28 w-28 items-center justify-center">
        <span className="absolute inset-0 animate-[cleanblue-spin-rev_1.6s_linear_infinite] rounded-full bg-[conic-gradient(from_0deg,transparent_15%,#1f7cff_50%,transparent_85%)]" />
        <span className="absolute inset-2 rounded-full bg-[#edf4ff]" />
        ...
        <span className="absolute inset-4 rounded-full bg-[#edf4ff]" />
        <span className="flex h-12 w-12 items-center justify-center rounded-full bg-[#1f7cff] text-white shadow-lg shadow-[#1f7cff]/30">
