# Glassy Blue (kaca biru terang) — panduan modul
...
- `ui/` — primitif: container, status-line, empty, author-avatar,
  article-meta, section-heading, glassy-blue-input, glassy-blue-button, loader.
- `seo/` — JSON-LD mandiri.
...
2. Template ini mengunci terang/gelap sendiri di bawah root `<html class="dark">` — form
   wajib pakai `ui/glassy-blue-input.tsx` / `ui/glassy-blue-button.tsx`,
