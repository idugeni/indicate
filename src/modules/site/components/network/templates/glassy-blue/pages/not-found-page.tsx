  ...
  return (
    <GlassyBlueShell site={site} path="/404">
      <div className="mx-auto w-full max-w-xl px-4 py-14 text-center md:py-20">
        <p className="m-0 inline-block rounded-full bg-[#1f7cff] px-3.5 py-1.5 font-sans text-xs font-bold tracking-wide text-white">
          404
        </p>
        ...
        <p className="m-0 mt-6">
          <Link
            href="/"
            className="inline-flex h-11 items-center rounded-full bg-[#1f7cff] px-6 font-sans text-sm font-bold text-white transition-colors hover:bg-[#155fd0]"
          >
            Kembali ke beranda
          </Link>
        </p>
