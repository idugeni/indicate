...
describe('GlassyBlueLoadMore', () => {
  it('null untuk daftar kosong', () => {
    const { container } = render(<GlassyBlueLoadMore articles={[]} heading="Terkini" description="d" />);
    expect(container.firstChild).toBe(null);
  });

  it('membuka halaman 9 pertama lalu memuat sisanya', () => {
    render(<GlassyBlueLoadMore articles={articles(12)} heading="Terkini" description="d" />);
  ...
  it('langsung tuntas bila kurang dari satu halaman', () => {
    render(<GlassyBlueLoadMore articles={articles(4)} heading="Terkini" description="d" />);
