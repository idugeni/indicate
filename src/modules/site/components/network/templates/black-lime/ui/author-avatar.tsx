...
export function AuthorAvatar({
  ...
  if (avatarUrl !== null && avatarUrl !== '') {
    ...
    return (
      <Image
        ...
        width={side}
        height={side}
        className={`${dimension} flex-none rounded-full object-cover ring-1 ring-[#242b1f]`}
      />
    );
  }
  ...
  return (
    <span
      aria-hidden="true"
      className={`${dimension} flex flex-none items-center justify-center rounded-full bg-[#c5f82a]/10 font-sans font-bold text-[#c5f82a]`}
    >
      {initial}
    </span>
  );
