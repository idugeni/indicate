# Black Lime Pulse (dark + lime) — panduan modul
...
- `ui/` — primitif: container, status-line, empty, author-avatar,
  article-meta, section-heading, black-lime-input, black-lime-button, loader.
- `seo/` — JSON-LD mandiri.
...
2. Template ini mengunci terang/gelap sendiri di bawah root `<html class="dark">` — form
   wajib pakai `ui/black-lime-input.tsx` / `ui/black-lime-button.tsx`,
