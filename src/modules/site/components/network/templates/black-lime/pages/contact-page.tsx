        ...
        {channels.length === 0 ? (
          ...
          <ul className="m-0 grid list-none gap-4 p-0 sm:grid-cols-2">
            {channels.map((channel) => {
              ...
              return (
                <li key={channel.key} className="m-0 rounded-2xl bg-[#131711] p-5 shadow-sm ring-1 ring-[#242b1f]/60">
                  <p className="m-0 flex items-center gap-2.5 font-sans text-base font-bold text-[#f2f5e9]">
                  ...
                  <a
                    ...
                    className="mt-2 inline-flex items-center gap-1 break-all font-sans text-sm font-semibold text-[#c5f82a] hover:underline"
                  >
