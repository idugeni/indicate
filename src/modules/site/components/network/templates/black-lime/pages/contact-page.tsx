                ...
                return (
                  <li key={channel.key} className="m-0">
                    <a
                      ...
                      className="flex items-center gap-3 rounded-2xl bg-[#131711] p-4 shadow-sm ring-1 ring-[#242b1f]/60 transition-colors hover:ring-[#c5f82a]/50"
                    >
                      <span className="flex h-10 w-10 flex-none items-center justify-center rounded-full bg-[#c5f82a]/10 text-[#c5f82a]">
