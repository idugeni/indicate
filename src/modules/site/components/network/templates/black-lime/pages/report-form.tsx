    ...
    <div className="space-y-4">
      ...
      <label className="block font-sans text-xs font-medium text-[#a3ad9a]">
        ...
        <input
          ...
          className="mt-1.5 block h-11 w-full rounded-xl border border-[#242b1f] bg-[#0a0c07] px-3.5 font-sans text-sm text-[#f2f5e9] focus:border-[#c5f82a] focus:outline-none"
        />
      </label>
      <label className="block font-sans text-xs font-medium text-[#a3ad9a]">
        ...
        <select
          ...
          className="mt-1.5 block h-11 w-full rounded-xl border border-[#242b1f] bg-[#0a0c07] px-3 font-sans text-sm text-[#f2f5e9] focus:border-[#c5f82a] focus:outline-none"
        >
      ...
      <label className="block font-sans text-xs font-medium text-[#a3ad9a]">
        ...
        <textarea
          ...
          className="mt-1.5 block w-full rounded-xl border border-[#242b1f] bg-[#0a0c07] px-3.5 py-2.5 font-sans text-sm text-[#f2f5e9] focus:border-[#c5f82a] focus:outline-none"
        />
      </label>
