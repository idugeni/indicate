    ...
    <div className="space-y-4">
      ...
      <label className="block font-sans text-xs font-medium text-[#a3ad9a]">
        ...
        <input
          ...
          className="mt-1.5 block h-11 w-full appearance-none rounded-xl border border-[#242b1f] bg-[#0a0c07] px-3.5 font-sans text-base text-[#f2f5e9] focus:border-[#c5f82a] focus:outline-none sm:text-sm"
        />
      </label>
      <label className="block font-sans text-xs font-medium text-[#a3ad9a]">
        ...
        <div className="relative mt-1.5">
          <select
            ...
            className="block h-11 w-full appearance-none rounded-xl border border-[#242b1f] bg-[#0a0c07] pl-3 pr-10 font-sans text-base text-[#f2f5e9] focus:border-[#c5f82a] focus:outline-none sm:text-sm"
          >
      ...
      <label className="block font-sans text-xs font-medium text-[#a3ad9a]">
        ...
        <textarea
          ...
          className="mt-1.5 block w-full appearance-none rounded-xl border border-[#242b1f] bg-[#0a0c07] px-3.5 py-2.5 font-sans text-base text-[#f2f5e9] focus:border-[#c5f82a] focus:outline-none sm:text-sm"
        />
      </label>
      {error ? <p className="m-0 font-sans text-xs font-medium text-red-600">{error}</p> : null}
      <button
        type="button" onClick={submit} disabled={busy}
        className="inline-flex h-11 items-center rounded-full bg-[#c5f82a] px-6 font-sans text-sm font-bold text-white transition-colors hover:bg-[#9ecb14] disabled:opacity-50"
      >
