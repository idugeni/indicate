# Warm Editorial (terakota serif) — panduan modul
...
- `ui/` — primitif: container, status-line, empty, author-avatar,
  article-meta, section-heading, warm-editorial-input, warm-editorial-button, loader.
- `seo/` — JSON-LD mandiri.
...
2. Template ini mengunci terang/gelap sendiri di bawah root `<html class="dark">` — form
   wajib pakai `ui/warm-editorial-input.tsx` / `ui/warm-editorial-button.tsx`,
