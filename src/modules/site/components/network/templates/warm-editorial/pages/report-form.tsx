    ...
    <div className="space-y-4">
      ...
      <label className="block font-sans text-xs font-medium text-slate-600">
        ...
        <input
          ...
          className="mt-1.5 block h-11 w-full rounded-xl border border-slate-200 bg-[#fdf7f0] px-3.5 font-sans text-sm text-slate-900 focus:border-[#b4532a] focus:outline-none"
        />
      </label>
      <label className="block font-sans text-xs font-medium text-slate-600">
        ...
        <select
          ...
          className="mt-1.5 block h-11 w-full rounded-xl border border-slate-200 bg-[#fdf7f0] px-3 font-sans text-sm text-slate-900 focus:border-[#b4532a] focus:outline-none"
        >
      ...
      <label className="block font-sans text-xs font-medium text-slate-600">
        ...
        <textarea
          ...
          className="mt-1.5 block w-full rounded-xl border border-slate-200 bg-[#fdf7f0] px-3.5 py-2.5 font-sans text-sm text-slate-900 focus:border-[#b4532a] focus:outline-none"
        />
      </label>
