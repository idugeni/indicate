        ...
        <article>
          <nav aria-label="Breadcrumb" className="flex flex-wrap items-center gap-1.5 font-sans text-xs text-slate-600">
            ...
            {article.categorySlug ? (
              <>
                <Link href={`/categories/${article.categorySlug}`} className="transition-colors hover:text-[#b4532a]">
          ...
          {article.categoryName === null ? null : (
            <p className="m-0 mt-6 flex items-center gap-2 font-sans text-sm font-semibold text-[#b4532a]">
          ...
          <p className="m-0 mt-4 block w-full border-l-[3px] border-[#b4532a] pl-4 font-sans text-[19px] font-medium leading-[1.7] text-slate-700">
          ...
          <aside aria-label="Catatan editorial" className="mt-6 border-l-[3px] border-[#b4532a] pl-4">
            <p className="m-0 flex items-center gap-1.5 font-sans text-sm font-bold text-[#b4532a]">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-2" aria-label="Topik artikel">
              {article.tags.map((tag) => (
                <Link
                  ...
                  className="rounded-full bg-white px-3 py-1.5 font-sans text-xs font-medium text-slate-600 ring-1 ring-slate-200 transition-colors hover:text-[#b4532a]"
                >
                  #{tag}
                </Link>
              ))}
          ...
          <footer className="mt-8 rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200/60 sm:p-6">
            <div className="flex items-center gap-4">
              {article.publisherLogoUrl ? (
                ...
                <span
                  aria-hidden="true"
                  className="flex h-14 w-14 flex-none items-center justify-center rounded-xl bg-[#b4532a]/10 font-sans text-xl font-bold text-[#b4532a]"
                >
              ...
              <div className="min-w-0">
                <p className="m-0 flex min-w-0 items-center gap-1.5 truncate font-sans text-base font-bold text-slate-900">
                  ...
                  {article.publisherVerified ? (
                    <BadgeCheck className="h-4 w-4 flex-none text-[#b4532a]" aria-label="Penerbit terverifikasi" />
                  ) : null}
                </p>
                ...
                {publisherChannels.map((channel) => {
                  ...
                  return (
                    <a
                      ...
                      title={channel.label}
                      className="flex h-9 w-9 items-center justify-center rounded-full text-slate-600 ring-1 ring-slate-200 transition-colors hover:text-[#b4532a]"
                    >
              ...
              <div className={`min-w-0 ${newer !== null && older === null ? 'col-span-2' : ''}`}>
                {newer !== null ? (
                  ...
                  >
                    ...
                    />
                    <span className="flex h-9 w-9 flex-none items-center justify-center rounded-full bg-[#fae7d7] text-[#b4532a] transition-colors group-hover:bg-[#b4532a] group-hover:text-white">
                    ...
                    <span className="min-w-0">
                      ...
                      <span className="mt-1 block font-sans text-sm font-semibold leading-snug text-slate-900 group-hover:text-[#b4532a]">
                        {newer.title}
                      </span>
                    </span>
                  </Link>
          ...
          <aside aria-label="Laporkan konten" className="mt-8 flex flex-col gap-4 rounded-2xl bg-[#b4532a]/5 p-4 ring-1 ring-[#b4532a]/15 sm:flex-row sm:items-center sm:p-5">
            <span className="flex h-10 w-10 flex-none items-center justify-center rounded-xl bg-[#b4532a]/10 text-[#b4532a]">
            ...
            <Link
              ...
              className="inline-flex flex-none items-center justify-center rounded-xl px-4 py-2.5 font-sans text-sm font-bold text-[#b4532a] ring-1 ring-[#b4532a]/30 transition-colors hover:bg-[#b4532a] hover:text-white"
            >
              Laporkan konten
            </Link>
          </aside>
