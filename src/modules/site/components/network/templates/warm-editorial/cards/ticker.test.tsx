...
describe('WarmEditorialTicker', () => {
  it('null untuk daftar kosong', () => {
    const { container } = render(<WarmEditorialTicker articles={[]} />);
    expect(container.firstChild).toBe(null);
  });

  it('menampilkan headline pertama dan lencana terkini', () => {
    render(<WarmEditorialTicker articles={buat(3)} />);
  ...
  it('satu artikel menyembunyikan kontrol navigasi', () => {
    render(<WarmEditorialTicker articles={buat(1)} />);
