...
describe('WarmEditorialHeroActions', () => {
  it('menyimpan dan melepas simpanan lokal', () => {
    render(<WarmEditorialHeroActions slug="berita-x" title="Judul X" />);
    ...
    expect(window.localStorage.getItem('warm-editorial:bookmark:berita-x')).toBe('1');
  ...
  it('memulihkan status tersimpan dari localStorage', () => {
    window.localStorage.setItem('warm-editorial:bookmark:berita-x', '1');
    render(<WarmEditorialHeroActions slug="berita-x" title="Judul X" />);
