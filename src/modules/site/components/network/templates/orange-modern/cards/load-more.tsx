...
export function OrangeModernLoadMore({
  articles,
  heading,
  description,
}: {
      ...
      {remaining > 0 ? (
        <div className="mt-8 flex justify-center">
          <button
            ...
            className="inline-flex h-11 items-center gap-2 rounded-full bg-[var(--tpl-primary,#ea580c)] px-7 font-sans text-sm font-bold text-white transition-colors hover:bg-[var(--tpl-primary-dark,#c2410c)]"
          >
