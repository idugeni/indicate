...
describe('OrangeModernViewBeacon', () => {
  it('mengirim beacon sekali saat mount', () => {
    const kirim = pasangBeacon(true);
    const { container } = render(<OrangeModernViewBeacon organizationId={O} siteId={S} articleSiteId={A} />);
  ...
  it('memakai fetch saat beacon ditolak', async () => {
    ...
    try {
      render(<OrangeModernViewBeacon organizationId={O} siteId={S} articleSiteId={A} />);
  ...
  it('diam untuk id tidak valid', () => {
    const kirim = pasangBeacon(true);
    render(<OrangeModernViewBeacon organizationId="bukan-uuid" siteId={S} articleSiteId={A} />);
