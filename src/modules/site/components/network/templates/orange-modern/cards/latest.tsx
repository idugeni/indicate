...
import { articleImage, formatFullViews, formatDate, isLocalImageSrc, readingMinutes } from '@/modules/site/components/network/templates/orange-modern/lib/format';
      ...
      <div className="relative mt-6 flex items-end justify-between gap-4">
        <div>
          ...
          <p className="m-0 mt-0.5 font-sans text-xs leading-relaxed text-white/80">
            Setiap berita adalah langkah kecil menuju perubahan besar.
          </p>
        </div>
        <Link
          href="/tentang"
