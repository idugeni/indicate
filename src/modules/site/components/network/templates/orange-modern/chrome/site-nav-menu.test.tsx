...
describe('OrangeModernDesktopNav', () => {
  it('menampilkan beranda, lima kategori, dan pemicu lainnya', () => {
    render(<OrangeModernDesktopNav categories={kanal(7)} path="/" />);
  ...
  it('menandai path aktif', () => {
    render(<OrangeModernDesktopNav categories={kanal(3)} path="/kat-2" />);
...
describe('OrangeModernMobileNav', () => {
  it('menampilkan seluruh kategori dan tautan informasi', () => {
    render(<OrangeModernMobileNav categories={kanal(3)} path="/" />);
    expect(screen.getByRole('link', { name: 'Beranda' })).toBeDefined();
  ...
  it('menandai path aktif', () => {
    render(<OrangeModernMobileNav categories={kanal(3)} path="/tentang" />);
