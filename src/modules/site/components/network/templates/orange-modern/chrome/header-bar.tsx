    ...
    <>
      <div className="mx-auto grid min-h-16 max-w-6xl grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-x-3 px-4 py-3 sm:gap-x-4 sm:px-6 lg:gap-x-6">
        ...
        <div className="flex flex-none items-center gap-2 justify-self-end">
          <Link
            href="#newsletter"
            className="hidden h-10 flex-none items-center rounded-full bg-[#ea580c] px-5 font-sans text-sm font-bold text-white shadow-sm transition-colors hover:bg-[#c2410c] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#ea580c] lg:inline-flex"
          >
            Langganan
          </Link>
          <button
            ...
            className="hidden h-10 w-10 flex-none items-center justify-center rounded-full bg-[#ea580c] font-sans text-sm font-bold text-white shadow-sm transition-colors hover:bg-[#c2410c] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#ea580c] lg:flex"
          >
          ...
          <button
            ...
            className="flex h-10 w-10 flex-none items-center justify-center rounded-full text-slate-600 ring-1 ring-slate-200 transition-colors hover:text-[#ea580c] lg:hidden"
          >
