                ...
                return (
                  <li key={channel.key} className="m-0">
                    <a
                      ...
                      className="flex items-center gap-3 rounded-2xl bg-white p-4 shadow-sm ring-1 ring-slate-200/60 transition-colors hover:ring-[#ea580c]/50"
                    >
                      <span className="flex h-10 w-10 flex-none items-center justify-center rounded-full bg-[#ea580c]/10 text-[#ea580c]">
