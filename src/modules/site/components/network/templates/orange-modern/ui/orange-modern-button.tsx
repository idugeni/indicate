 ...
 */
export function OrangeModernGhostButton({ className, ...props }: ComponentProps<typeof Button>) {
  return (
    <Button
      variant="ghost"
      {...props}
 ...
 */
export function OrangeModernPrimaryButton({ className, ...props }: ComponentProps<typeof Button>) {
  return (
    <Button
      {...props}
      className={cn('bg-[#ea580c] font-sans font-bold text-white hover:bg-[#c2410c]', className)}
    />
  );
}
