# Red Editorial (merah serif) — panduan modul
...
- `ui/` — primitif: container, status-line, empty, author-avatar,
  article-meta, section-heading, red-editorial-input, red-editorial-button, loader.
- `seo/` — JSON-LD mandiri.
...
2. Template ini mengunci terang/gelap sendiri di bawah root `<html class="dark">` — form
   wajib pakai `ui/red-editorial-input.tsx` / `ui/red-editorial-button.tsx`,
