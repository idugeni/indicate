          ...
          <section aria-label="Penerbit">
            ...
            <div className="mt-4 rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200/60">
              <div className="flex items-center gap-3">
                <span aria-hidden="true" className="flex h-12 w-12 flex-none items-center justify-center rounded-xl bg-[#b91c1c]/10 font-sans text-xl font-bold text-[#b91c1c]">
                ...
                <div className="min-w-0">
                  <p className="m-0 flex min-w-0 items-center gap-1.5 font-sans text-base font-bold text-slate-900">
                    ...
                    {publisher.verified ? <BadgeCheck className="h-4 w-4 flex-none text-[#b91c1c]" aria-label="Penerbit terverifikasi" /> : null}
                  </p>
                  ...
                  {publisherChannels.map((channel) => {
                    ...
                    return (
                      <a
                        ...
                        title={channel.label}
                        className="flex h-9 w-9 items-center justify-center rounded-full text-slate-500 ring-1 ring-slate-200 transition-colors hover:text-[#b91c1c]"
                      >
