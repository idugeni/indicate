...
export function RedEditorialReportForm({ articleSlug }: { readonly articleSlug: string | null }) {
    ...
    <div className="space-y-4">
      ...
      <label className="block font-sans text-xs font-medium text-slate-600">
        ...
        <input
          ...
          className="mt-1.5 block h-11 w-full appearance-none rounded-xl border border-slate-200 bg-[#fffafa] px-3.5 font-sans text-base text-slate-900 focus:border-[#b91c1c] focus:outline-none sm:text-sm"
        />
      </label>
      <label className="block font-sans text-xs font-medium text-slate-600">
        ...
        <div className="relative mt-1.5">
          <select
            ...
            className="block h-11 w-full appearance-none rounded-xl border border-slate-200 bg-[#fffafa] pl-3 pr-10 font-sans text-base text-slate-900 focus:border-[#b91c1c] focus:outline-none sm:text-sm"
          >
      ...
      <label className="block font-sans text-xs font-medium text-slate-600">
        ...
        <textarea
          ...
          className="mt-1.5 block w-full appearance-none rounded-xl border border-slate-200 bg-[#fffafa] px-3.5 py-2.5 font-sans text-base text-slate-900 focus:border-[#b91c1c] focus:outline-none sm:text-sm"
        />
      </label>
      {error ? <p className="m-0 font-sans text-xs font-medium text-red-600">{error}</p> : null}
      <button
        type="button" onClick={submit} disabled={busy}
        className="inline-flex h-11 items-center rounded-full bg-[#b91c1c] px-6 font-sans text-sm font-bold text-white transition-colors hover:bg-[#7f1212] disabled:opacity-50"
      >
