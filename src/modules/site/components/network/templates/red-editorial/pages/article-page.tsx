...
import { articleImage, authorDisplayName, formatDate, formatFullViews, isLocalImageSrc, readingMinutes } from '@/modules/site/components/network/templates/red-editorial/lib/format';
      ...
      <div className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-6 md:py-12">
        <article>
          ...
          <aside aria-label="Catatan editorial" className="mt-6 border-l-[3px] border-[#b91c1c] pl-4">
            <p className="m-0 flex items-center gap-1.5 font-sans text-sm font-bold text-[#b91c1c]">
