...
describe('SoftBlueLoadMore', () => {
  it('null untuk daftar kosong', () => {
    const { container } = render(<SoftBlueLoadMore articles={[]} heading="Terkini" description="d" />);
    expect(container.firstChild).toBe(null);
  });

  it('membuka halaman 9 pertama lalu memuat sisanya', () => {
    render(<SoftBlueLoadMore articles={articles(12)} heading="Terkini" description="d" />);
  ...
  it('langsung tuntas bila kurang dari satu halaman', () => {
    render(<SoftBlueLoadMore articles={articles(4)} heading="Terkini" description="d" />);
