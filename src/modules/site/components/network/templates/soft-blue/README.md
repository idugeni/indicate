# Soft Blue Cards (biru lembut) — panduan modul
...
- `ui/` — primitif: container, status-line, empty, author-avatar,
  article-meta, section-heading, soft-blue-input, soft-blue-button, loader.
- `seo/` — JSON-LD mandiri.
...
2. Template ini mengunci terang/gelap sendiri di bawah root `<html class="dark">` — form
   wajib pakai `ui/soft-blue-input.tsx` / `ui/soft-blue-button.tsx`,
