                ...
                return (
                  <li key={channel.key} className="m-0">
                    <a
                      ...
                      className="flex items-center gap-3 rounded-2xl bg-white p-4 shadow-sm ring-1 ring-slate-200/60 transition-colors hover:ring-[#2563eb]/50"
                    >
                      <span className="flex h-10 w-10 flex-none items-center justify-center rounded-full bg-[#2563eb]/10 text-[#2563eb]">
