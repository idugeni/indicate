        ...
        <div className="flex flex-col gap-2.5 sm:flex-row">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="h-11 w-full rounded-full border border-slate-200 bg-[#f1f6ff] pl-11 pr-4 font-sans text-sm text-slate-900 placeholder:text-slate-400 focus:border-[#2563eb] focus:outline-none"
            />
          </div>
          <button
            type="submit"
...
export function SoftBlueSearchResults({ articles, query }: { readonly articles: readonly NetworkArticle[]; readonly query: string }) {
