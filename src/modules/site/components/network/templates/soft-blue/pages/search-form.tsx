...
export function SoftBlueSearchForm({ query }: { readonly query: string }) {
  return (
        ...
        <div className="flex flex-col gap-2.5 sm:flex-row">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="h-11 w-full appearance-none rounded-full border border-slate-200 bg-[#f1f6ff] pl-11 pr-4 font-sans text-base text-slate-900 placeholder:text-slate-400 focus:border-[#2563eb] focus:outline-none sm:text-sm"
            />
          </div>
          <button
            type="submit"
...
export function SoftBlueSearchResults({ articles, query }: { readonly articles: readonly ArticleListItem[]; readonly query: string }) {
