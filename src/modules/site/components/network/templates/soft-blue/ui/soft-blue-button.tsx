 ...
 */
export function SoftBlueGhostButton({ className, ...props }: ComponentProps<typeof Button>) {
  return (
    <Button
      variant="ghost"
      {...props}
 ...
 */
export function SoftBluePrimaryButton({ className, ...props }: ComponentProps<typeof Button>) {
  return (
    <Button
      {...props}
      className={cn('bg-[#2563eb] font-sans font-bold text-white hover:bg-[#1d4ed8]', className)}
    />
  );
}
