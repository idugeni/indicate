...
export function DarkNavyMobileNav({ categories, path }: { readonly categories: readonly CategoryNavItem[]; readonly path: string }) {
  return (
    <div className="space-y-6">
      ...
      <div>
        <p className="m-0 px-4 font-sans text-xs font-bold uppercase tracking-wider text-[#5f6f8c]">Kategori</p>
      ...
      <div>
        <p className="m-0 px-4 font-sans text-xs font-bold uppercase tracking-wider text-[#5f6f8c]">Informasi</p>
        <ul className="m-0 mt-2 list-none space-y-1 p-0">
          {INFO_LINKS.map((item) => (
