...
export function AuthorAvatar({
  ...
  if (avatarUrl !== null && avatarUrl !== '') {
    ...
    return (
      <Image
        ...
        width={side}
        height={side}
        className={`${dimension} flex-none rounded-full object-cover ring-1 ring-[#1b2c4f]`}
      />
    );
  }
  ...
  return (
    <span
      aria-hidden="true"
      className={`${dimension} flex flex-none items-center justify-center rounded-full bg-[#2f7bff]/10 font-sans font-bold text-[#2f7bff]`}
    >
      {initial}
    </span>
  );
