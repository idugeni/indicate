      ...
      <div className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-6 md:py-12">
        <article>
          ...
          <aside aria-label="Catatan editorial" className="mt-6 border-l-[3px] border-[#2f7bff] pl-4">
            <p className="m-0 flex items-center gap-1.5 font-sans text-sm font-bold text-[#2f7bff]">
              <Info className="h-4 w-4 flex-none" aria-hidden="true" />
              Catatan Editorial
            </p>
            <p className="m-0 mt-1.5 font-sans text-[13px] leading-relaxed text-[#9aa9c4]">
