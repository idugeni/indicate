...
import { articleImage, authorDisplayName, formatDate, formatFullViews, readingMinutes } from '@/modules/site/components/network/templates/purple-editorial/lib/format';
    ...
    <PurpleEditorialShell site={site} path={`/${article.slug}`}>
      ...
      <div className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-6 md:py-12">
        <article>
          ...
          <aside aria-label="Laporkan konten" className="mt-8 flex flex-col gap-4 rounded-2xl bg-[#7c3aed]/5 p-4 ring-1 ring-[#7c3aed]/15 sm:flex-row sm:items-center sm:p-5">
            <span className="flex h-10 w-10 flex-none items-center justify-center rounded-xl bg-[#7c3aed]/10 text-[#7c3aed]">
            ...
            <Link
              ...
              className="inline-flex flex-none items-center justify-center rounded-xl px-4 py-2.5 font-sans text-sm font-bold text-[#7c3aed] ring-1 ring-[#7c3aed]/30 transition-colors hover:bg-[#7c3aed] hover:text-white"
            >
              Laporkan konten
            </Link>
          </aside>
