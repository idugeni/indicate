...
describe('PurpleEditorialDesktopNav', () => {
  it('menampilkan beranda, lima kategori, dan pemicu lainnya', () => {
    render(<PurpleEditorialDesktopNav categories={kanal(7)} path="/" />);
  ...
  it('menandai path aktif', () => {
    render(<PurpleEditorialDesktopNav categories={kanal(3)} path="/kat-2" />);
...
describe('PurpleEditorialMobileNav', () => {
  it('menampilkan seluruh kategori dan tautan informasi', () => {
    render(<PurpleEditorialMobileNav categories={kanal(3)} path="/" />);
    expect(screen.getByRole('link', { name: 'Beranda' })).toBeDefined();
  ...
  it('menandai path aktif', () => {
    render(<PurpleEditorialMobileNav categories={kanal(3)} path="/tentang" />);
