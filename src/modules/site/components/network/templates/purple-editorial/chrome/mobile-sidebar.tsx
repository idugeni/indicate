      ...
      >
        <div className="flex items-center justify-between gap-3 border-b border-slate-100 px-5 py-4">
          ...
          <button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full text-slate-600 ring-1 ring-slate-200 transition-colors hover:text-[var(--tpl-primary,#7c3aed)]"
          >
        ...
        <form role="search" onSubmit={submitSidebar} className="flex flex-none items-center gap-2 border-b border-slate-100 px-5 py-3">
          <label htmlFor="purple-editorial-sidebar-search" className="sr-only">
            Cari berita
          </label>
          <TemplateInput
            id="purple-editorial-sidebar-search"
            value={sidebarQuery}
        ...
        <div className="flex-none border-t border-slate-100 px-5 py-4" onClick={onClose}>
          <ul className="m-0 grid list-none grid-cols-2 gap-x-3 gap-y-2 p-0 font-sans text-xs">
            <li><Link href="/tentang" className="text-slate-500 transition-colors hover:text-[var(--tpl-primary,#7c3aed)]">Tentang</Link></li>
            <li><Link href="/kontak" className="text-slate-500 transition-colors hover:text-[var(--tpl-primary,#7c3aed)]">Kontak</Link></li>
            <li><Link href="/kebijakan-privasi" className="text-slate-500 transition-colors hover:text-[var(--tpl-primary,#7c3aed)]">Kebijakan Privasi</Link></li>
            <li><Link href="/syarat-ketentuan" className="text-slate-500 transition-colors hover:text-[var(--tpl-primary,#7c3aed)]">Syarat & Ketentuan</Link></li>
          </ul>
        </div>
      </div>
    </div>,
