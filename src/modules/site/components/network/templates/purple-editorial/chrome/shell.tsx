...
export function PurpleEditorialShell({
  ...
  return (
    <div className="flex min-h-screen flex-col supports-[min-height:100svh]:min-h-svh bg-[#f8f7ff] font-sans text-slate-900 antialiased" data-template="purple-editorial">
      <a
        href="#main-content"
