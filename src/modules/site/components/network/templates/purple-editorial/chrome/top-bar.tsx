 ...
 */
export function PurpleEditorialTopBar({ site }: { readonly site: NetworkSiteData }) {
    ...
    <div className="hidden border-b border-slate-100 bg-[#f8f7ff] md:block">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-2 sm:px-6">
        <p className="m-0 flex min-w-0 items-center gap-2 font-sans text-xs text-slate-600">
          ...
          <span aria-hidden="true" className="h-0.5 w-6 flex-none rounded-full bg-[#7c3aed]/40" />
              ...
              {socials.map((channel) => {
                ...
                return (
                  <a
                    ...
                    className="flex h-6 w-6 items-center justify-center rounded-full text-slate-500 transition-colors hover:text-[#7c3aed]"
                  >
