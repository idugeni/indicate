...
describe('PurpleEditorialHeroActions', () => {
  it('menyimpan dan melepas simpanan lokal', () => {
    render(<PurpleEditorialHeroActions slug="berita-x" title="Judul X" />);
    ...
    expect(window.localStorage.getItem('purple-editorial:bookmark:berita-x')).toBe('1');
  ...
  it('memulihkan status tersimpan dari localStorage', () => {
    window.localStorage.setItem('purple-editorial:bookmark:berita-x', '1');
    render(<PurpleEditorialHeroActions slug="berita-x" title="Judul X" />);
