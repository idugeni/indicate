...
describe('PurpleEditorialTicker', () => {
  it('null untuk daftar kosong', () => {
    const { container } = render(<PurpleEditorialTicker articles={[]} />);
    expect(container.firstChild).toBe(null);
  });

  it('menampilkan headline pertama dan lencana terkini', () => {
    render(<PurpleEditorialTicker articles={buat(3)} />);
  ...
  it('satu artikel menyembunyikan kontrol navigasi', () => {
    render(<PurpleEditorialTicker articles={buat(1)} />);
