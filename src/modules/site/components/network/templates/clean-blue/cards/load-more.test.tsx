...
describe('CleanBlueLoadMore', () => {
  it('null untuk daftar kosong', () => {
    const { container } = render(<CleanBlueLoadMore articles={[]} heading="Terkini" description="d" />);
    expect(container.firstChild).toBe(null);
  });

  it('membuka halaman 9 pertama lalu memuat sisanya', () => {
    render(<CleanBlueLoadMore articles={articles(12)} heading="Terkini" description="d" />);
  ...
  it('langsung tuntas bila kurang dari satu halaman', () => {
    render(<CleanBlueLoadMore articles={articles(4)} heading="Terkini" description="d" />);
