...
describe('CleanBlueViewBeacon', () => {
  it('mengirim beacon sekali saat mount', () => {
    const kirim = pasangBeacon(true);
    const { container } = render(<CleanBlueViewBeacon organizationId={O} siteId={S} articleSiteId={A} />);
  ...
  it('memakai fetch saat beacon ditolak', async () => {
    ...
    try {
      render(<CleanBlueViewBeacon organizationId={O} siteId={S} articleSiteId={A} />);
  ...
  it('diam untuk id tidak valid', () => {
    const kirim = pasangBeacon(true);
    render(<CleanBlueViewBeacon organizationId="bukan-uuid" siteId={S} articleSiteId={A} />);
