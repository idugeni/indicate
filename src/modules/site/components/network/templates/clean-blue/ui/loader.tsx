...
export function CleanBlueLoader() {
  return (
    <div
      ...
      aria-busy="true"
      aria-label="Memuat"
      className="flex min-h-screen items-center justify-center bg-[#f5f8fd]"
    >
      <div aria-hidden="true" className="relative flex h-28 w-28 items-center justify-center">
        <span className="absolute inset-0 animate-[cleanblue-spin-rev_1.6s_linear_infinite] rounded-full bg-[conic-gradient(from_0deg,transparent_15%,#1a5fd0_50%,transparent_85%)]" />
        <span className="absolute inset-2 rounded-full bg-[#f5f8fd]" />
        ...
        <span className="absolute inset-4 rounded-full bg-[#f5f8fd]" />
        <span className="flex h-12 w-12 items-center justify-center rounded-full bg-[#1a5fd0] text-white shadow-lg shadow-[#1a5fd0]/30">
