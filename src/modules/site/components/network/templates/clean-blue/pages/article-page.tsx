    ...
    <CleanBlueShell site={site} path={`/${article.slug}`}>
      ...
      <div className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-6 md:py-12">
        <article>
          ...
          <aside aria-label="Catatan editorial" className="mt-6 border-l-[3px] border-[#1a5fd0] pl-4">
            <p className="m-0 flex items-center gap-1.5 font-sans text-sm font-bold text-[#1a5fd0]">
