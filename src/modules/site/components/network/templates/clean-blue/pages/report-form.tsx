...
export function CleanBlueReportForm({ articleSlug }: { readonly articleSlug: string | null }) {
    ...
    <div className="space-y-4">
      ...
      <label className="block font-sans text-xs font-medium text-slate-600">
        ...
        <input
          ...
          className="mt-1.5 block h-11 w-full appearance-none rounded-xl border border-slate-200 bg-[#f5f8fd] px-3.5 font-sans text-base text-slate-900 focus:border-[#1a5fd0] focus:outline-none sm:text-sm"
        />
      </label>
      <label className="block font-sans text-xs font-medium text-slate-600">
        ...
        <div className="relative mt-1.5">
          <select
            ...
            className="block h-11 w-full appearance-none rounded-xl border border-slate-200 bg-[#f5f8fd] pl-3 pr-10 font-sans text-base text-slate-900 focus:border-[#1a5fd0] focus:outline-none sm:text-sm"
          >
      ...
      <label className="block font-sans text-xs font-medium text-slate-600">
        ...
        <textarea
          ...
          className="mt-1.5 block w-full appearance-none rounded-xl border border-slate-200 bg-[#f5f8fd] px-3.5 py-2.5 font-sans text-base text-slate-900 focus:border-[#1a5fd0] focus:outline-none sm:text-sm"
        />
      </label>
