  ...
  return (
    ...
    >
      <div aria-hidden="true" className="relative flex h-28 w-28 items-center justify-center">
        <span className="absolute inset-0 animate-[cleanblue-spin-rev_1.6s_linear_infinite] rounded-full bg-[conic-gradient(from_0deg,transparent_15%,#1f6feb_50%,transparent_85%)]" />
        ...
        <span className="flex h-12 w-12 items-center justify-center rounded-full bg-[#1f6feb] text-white shadow-lg shadow-[#1f6feb]/30">
