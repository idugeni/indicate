    ...
    <table class="layout" role="presentation"><tbody><tr>
      ...
      <td style="width: 50%; padding-left: 12px;">
        <table role="presentation" style="width: 100%; border-collapse: collapse; font-size: 13px;"><tbody>
          ...
          <tr><td style="color: var(--ash); white-space: nowrap; padding: 3px 0;">Metode Pembayaran</td><td style="color: var(--ash); width: 14px; text-align: center; padding: 3px 0;">:</td><td style="font-family: 'IBM Plex Mono', monospace; font-weight: 500; text-align: right; padding: 3px 0;">Transfer bank</td></tr>
        </tbody></table>
      </td>
    </tr></tbody></table>
  </section>
