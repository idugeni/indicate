...
CREATE TYPE "public"."publisher_type" AS ENUM('government_institution', 'correctional_institution', 'public_relations_office', 'company', 'organization', 'community', 'independent_publisher');--> statement-breakpoint
