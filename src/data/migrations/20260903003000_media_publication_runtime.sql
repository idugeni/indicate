...
FOR EACH ROW EXECUTE FUNCTION indicate_private.enforce_job_transition();--> statement-breakpoint
...
FOR EACH ROW EXECUTE FUNCTION indicate_private.enforce_target_transition();--> statement-breakpoint
...
FOR EACH ROW EXECUTE FUNCTION indicate_private.enforce_article_site_transition();--> statement-breakpoint
...
REVOKE ALL ON FUNCTION indicate_private.claim_dispatch_gaps(timestamptz, integer, uuid, timestamptz) FROM PUBLIC;--> statement-breakpoint
REVOKE ALL ON FUNCTION indicate_private.find_expired_leases(timestamptz, integer) FROM PUBLIC;--> statement-breakpoint
REVOKE ALL ON FUNCTION indicate_private.claim_transition_receipts(timestamptz, integer, uuid, timestamptz) FROM PUBLIC;--> statement-breakpoint
REVOKE ALL ON FUNCTION indicate_private.claim_cleanup_tasks(timestamptz, integer, uuid, timestamptz) FROM PUBLIC;--> statement-breakpoint
GRANT EXECUTE ON FUNCTION indicate_private.claim_dispatch_gaps(timestamptz, integer, uuid, timestamptz) TO indicate_runtime;--> statement-breakpoint
GRANT EXECUTE ON FUNCTION indicate_private.find_expired_leases(timestamptz, integer) TO indicate_runtime;--> statement-breakpoint
GRANT EXECUTE ON FUNCTION indicate_private.claim_transition_receipts(timestamptz, integer, uuid, timestamptz) TO indicate_runtime;--> statement-breakpoint
GRANT EXECUTE ON FUNCTION indicate_private.claim_cleanup_tasks(timestamptz, integer, uuid, timestamptz) TO indicate_runtime;--> statement-breakpoint
