...
export type ControlSurface = 'cms' | 'api' | 'webhook';
...
export type ActivationPhase = 'pending' | 'cloudflare_verified' | 'vercel_associated' | 'probe_verified' | 'active' | 'deactivating' | 'completed' | 'failed';
