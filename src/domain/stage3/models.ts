...
export type PublishingState = 'queued' | 'processing' | 'published' | 'failed' | 'retrying';
...
export interface AuditRecord {
  ...
  readonly entryPoint: 'cms' | 'api' | 'telegram' | 'worker' | 'reconciler';
...
export interface Stage3TenantState {
  readonly organizationId: string;
...
export interface PublicPublisherClaim {
