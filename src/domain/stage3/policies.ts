...
export function filterArticles(state: Stage3TenantState, filter: ArticleFilter): readonly ArticleRecord[] {
...
export function buildPublicPublisherClaim(
...
export function buildDashboard(state: Stage3TenantState): DashboardProjection {
